...
export const VOLUME_LANDMARKS: readonly VolumeLandmark[] = [
  ...
  { muscleGroupId: 'traps', mv: 0, mev: 2, mavLow: 6, mavHigh: 12, mrv: 16, sourceConfidence: 'published' },
  { muscleGroupId: 'front_delts', mv: 0, mev: 0, mavLow: 6, mavHigh: 8, mrv: 12, sourceConfidence: 'published' },
  { muscleGroupId: 'rear_delts', mv: 0, mev: 6, mavLow: 12, mavHigh: 20, mrv: 26, sourceConfidence: 'published' },
  { muscleGroupId: 'biceps', mv: 0, mev: 4, mavLow: 8, mavHigh: 14, mrv: 20, sourceConfidence: 'published' },
  { muscleGroupId: 'triceps', mv: 0, mev: 4, mavLow: 8, mavHigh: 14, mrv: 18, sourceConfidence: 'published' },
  { muscleGroupId: 'forearms', mv: 0, mev: 2, mavLow: 6, mavHigh: 10, mrv: 16, sourceConfidence: 'published' },
  { muscleGroupId: 'abs', mv: 0, mev: 0, mavLow: 8, mavHigh: 16, mrv: 25, sourceConfidence: 'published' },
  ...
  { muscleGroupId: 'glutes', mv: 0, mev: 4, mavLow: 8, mavHigh: 16, mrv: 20, sourceConfidence: 'published' },
  { muscleGroupId: 'calves', mv: 0, mev: 6, mavLow: 8, mavHigh: 16, mrv: 20, sourceConfidence: 'published' },
  // Estimated (no standard published RP entry) — see landmarks.md.
  { muscleGroupId: 'obliques', mv: 0, mev: 2, mavLow: 6, mavHigh: 10, mrv: 16, sourceConfidence: 'estimated' },
  { muscleGroupId: 'adductors', mv: 0, mev: 2, mavLow: 6, mavHigh: 10, mrv: 16, sourceConfidence: 'estimated' },
  { muscleGroupId: 'abductors', mv: 0, mev: 2, mavLow: 6, mavHigh: 10, mrv: 16, sourceConfidence: 'estimated' },
  { muscleGroupId: 'neck', mv: 0, mev: 2, mavLow: 4, mavHigh: 8, mrv: 12, sourceConfidence: 'estimated' },
]
